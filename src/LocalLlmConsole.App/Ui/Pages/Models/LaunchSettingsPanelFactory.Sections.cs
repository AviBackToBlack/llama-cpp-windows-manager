...
public static partial class LaunchSettingsPanelFactory
{
    ...
    private static LaunchSettingsFormControls AddLaunchSections(StackPanel panel, LaunchSettingsPanelBuilder builder, LaunchSettingsPanelRequest request, WpfTextBox launchPortBox)
    {
        ...
        var runtimeDiscoveredFlagsText = Text("", 11, false, true);
        runtimeDiscoveredFlagsText.TextWrapping = TextWrapping.Wrap;
        runtimeDiscoveredFlagsText.ToolTip = Loc.T("Tooltip.Field.RuntimeDiscoveredFlags");
        builder.AddAdvancedLaunchSetting(serverGrid, Loc.T("Launch.Field.RuntimeDiscoveredFlags"), runtimeDiscoveredFlagsText);
        formControls.RuntimeDiscoveredFlagsText = runtimeDiscoveredFlagsText;
