...
/// <remarks>Mappings from the launch request and saved settings live in RuntimeModels.LaunchOptions.cs.</remarks>
public sealed partial record LlamaServerLaunchOptions
{
    ...
    public IReadOnlyDictionary<string, string> FlagValues { get; init; } = ImmutableDictionary<string, string>.Empty;
    public IReadOnlySet<string>? SupportedFlags { get; init; }
    public IReadOnlyList<string>? FlagOrder { get; init; }
}
