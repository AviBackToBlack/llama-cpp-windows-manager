...
public sealed class SettingsPageDefinitionService
{
    ...
    [
        ...
        new(Loc.T("Settings.Group.OpenCode"), Loc.T("Setting.AutoSyncEntries"), "autoSaveOpenCodeOnLaunchSettingsSave", AppPreferenceService.YesNoLabel(settings.AutoSaveOpenCodeOnLaunchSettingsSave), "choice", AppPreferenceService.YesNoOptions(),
            ToolTip: Loc.T("Tooltip.Setting.AutoSyncEntries")),
        new(Loc.T("Settings.Group.OpenCode"), Loc.T("Setting.LimitOutput"), "openCodeOutputLimit", settings.OpenCodeOutputLimit.ToString(CultureInfo.InvariantCulture),
            ToolTip: Loc.T("Tooltip.Setting.LimitOutput", AppSettings.MaxOpenCodeOutputLimit.ToString(CultureInfo.InvariantCulture))),
