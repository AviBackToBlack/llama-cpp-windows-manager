...
public static class LlamaServerFlagSchema
{
    ...
    [
        ...
        new LlamaServerFlag(["--fit", "-fit"], "Memory", FlagValueType.Enum, "off", AllowedValues: ["on", "off"], Description: "Adjust unset arguments to fit in device memory."),
        ...
        new LlamaServerFlag(["--lora"], "Model", FlagValueType.CommaList, Description: "Path to LoRA adapter."),
        new LlamaServerFlag(["--lora-scaled"], "Model", FlagValueType.CommaList, Description: "Path to LoRA adapter with scaling (FNAME:SCALE)."),
        new LlamaServerFlag(["--control-vector"], "Model", FlagValueType.File, Description: "Add a control vector."),
        new LlamaServerFlag(["--control-vector-scaled"], "Model", FlagValueType.CommaList, Description: "Add a control vector with scaling."),
        new LlamaServerFlag(["--control-vector-layer-range"], "Model", FlagValueType.CommaList, Description: "Control vector layer range (START END)."),

        // Model loading
        new LlamaServerFlag(["--model", "-m"], "Model", FlagValueType.File, Description: "Model path to load.", IsSecurityCritical: true),
        ...
        new LlamaServerFlag(["--verbosity", "-lv", "--log-verbosity"], "Logging", FlagValueType.Int, 0, Min: 0, Description: "Set verbosity threshold."),
        ...
        new LlamaServerFlag(["--adaptive-target"], "Sampling", FlagValueType.Double, 0.0, Min: 0, Max: 1, Description: "Adaptive-p target probability."),
        new LlamaServerFlag(["--adaptive-decay"], "Sampling", FlagValueType.Double, 0.0, Min: 0, Description: "Adaptive-p decay rate."),
        ...
        new LlamaServerFlag(["--ctx-checkpoints", "-ctxcp", "--swa-checkpoints"], "Memory", FlagValueType.Int, 0, Min: 0, Description: "Max number of context checkpoints per slot."),
        ...
        new LlamaServerFlag(["--mtmd-batch-max-tokens"], "Vision", FlagValueType.Int, 0, Min: 0, Description: "Maximum image tokens per batch."),
        ...
        new LlamaServerFlag(["--ui-mcp-proxy", "--webui-mcp-proxy"], "Server", FlagValueType.Boolean, false, Description: "Enable MCP CORS proxy (experimental)."),
        ...
        new LlamaServerFlag(["--tools"], "Server", FlagValueType.CommaList, Description: "Enable built-in tools for AI agents (experimental)."),
        new LlamaServerFlag(["--agent", "-ag"], "Server", FlagValueType.Boolean, false, Description: "Enable CORS proxy and all built-in tools."),
        ...
        new LlamaServerFlag(["--api-key-file"], "Server", FlagValueType.File, Description: "Path to file containing API keys."),
        ...
        new LlamaServerFlag(["--models-max"], "Server", FlagValueType.Int, 0, Min: 0, Description: "Max number of models to load simultaneously for router."),
        ...
        new LlamaServerFlag(["--slot-prompt-similarity", "-sps"], "Server", FlagValueType.Double, 0.0, Min: 0, Max: 1, Description: "Prompt similarity threshold for slot reuse."),
        ...
        new LlamaServerFlag(["--sleep-idle-seconds"], "Server", FlagValueType.Int, 0, Min: 0, Description: "Seconds of idleness after which server sleeps."),
