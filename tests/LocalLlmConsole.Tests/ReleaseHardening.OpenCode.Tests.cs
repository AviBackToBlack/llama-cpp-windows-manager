...
public sealed partial class ReleaseHardeningTests
{
    ...
    public void OpenCodePageLayoutLivesBehindFactory()
    {
        ...
        Assert.Contains("OpenCode.SectionModelsTitle", factory, StringComparison.Ordinal);
        Assert.Contains("OpenCode.SectionAgentsTitle", factory, StringComparison.Ordinal);
        Assert.Contains("OpenCode.DetectFilesButton", factory, StringComparison.Ordinal);
        Assert.Contains("OpenCode.ChooseConfigButton", factory, StringComparison.Ordinal);
        Assert.Contains("OpenCode.ChooseAgentsFolderButton", factory, StringComparison.Ordinal);
        Assert.Contains("OpenCode.AddAsNewButton", factory, StringComparison.Ordinal);
        Assert.Contains("OpenCode.AgentKind.MarkdownFile", factory, StringComparison.Ordinal);
